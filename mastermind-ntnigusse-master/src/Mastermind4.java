...
public class Mastermind4 {
    ...
    public int computeExacts( String guess) {
        StringBuilder Secret=this.generateSecret();
        int exacts = 0;
        for (int i = 0; i < 4; i++){
    ...
    public int computePartials(String guess) {
    ...
    public void main(String[] args) {
        ...
        while (!done) {
            ...
            System.out.print("Exacts:" + computeExacts( user_Guess) + "\r\n");
            System.out.println("Partials:" + computePartials(user_Guess) + "\r\n");

            if (computeExacts(user_Guess) == 4) {
