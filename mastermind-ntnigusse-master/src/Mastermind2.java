...
public class Mastermind2 {
    ...
    static public StringBuilder generateSecret() {
    ...
    public static String processGuess(String guess) {
        String ok_letters;
        String ok_length = "";
        String ok = "";
        for (int i = 0; i < 4; i++) {
    ...
    static public int computeExacts(StringBuilder Secret, String guess) {
        int exacts = 0;
        for (int i = 0; i < 4; i++) {
    ...
    static public int computePartials(StringBuilder Secret, String guess) {
